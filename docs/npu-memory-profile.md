...
The measurements above predate activation pooling. See [activation memory management](npu-activation-memory.md) for current lifetime rules, physical allocation categories, dedicated-allocation comparisons and updated per-rank measurements.
