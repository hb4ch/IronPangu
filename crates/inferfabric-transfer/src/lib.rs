...
use inferfabric_model::{Error, Result, Spec, invalid};
use inferfabric_runtime::{DeviceRegion, HybridState};
...
impl Lease {
    pub fn binding(&self) -> inferfabric_runtime::StateBinding {
        inferfabric_runtime::StateBinding {
            slot: self.slot,
